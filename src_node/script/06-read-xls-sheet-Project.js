...
const create_gantt = (obj) => {
    return [
        {
            title: "WP&B, WP, & AFE atau Teknis",
            relv: true,
            perc: obj["WP&B, WP, & AFE atau Teknis (%)"] * 100 || 0
        },
        {
            title: "Validasi Desain Parameter",
            relv: true,
            perc: obj["Validasi Desain Parameter (%)"] * 100 || 0
        },
        {
            title: "Pengadaan Barang dan Jasa",
            relv: true,
            perc: obj["Pengadaan Barang dan Jasa (%)"] * 100    || 0
        },
        {
            title: "Persetujuan UKL UPL (untuk Survei Seismik) dan izin berusaha/berkegiatan",
            relv: true,
            perc: obj["Persetujuan UKL UPL (untuk Survei Seismik) dan izin berusaha/berkegiatan (%)"] * 100    || 0
        },
        {
            title: "Surat Pemberitahuan Pelaksanaan Kegiatan Survey",
            relv: true,
            perc: obj["Surat Pemberitahuan Pelaksanaan Kegiatan Survey (%)"] * 100    || 0
        },
        {
            title: "Surat Pemberitahuan Memasuki Wilayah Open Area",
            relv: true,
            perc: obj["Surat Pemberitahuan Memasuki Wilayah Open Area (%)"] * 100    || 0
        },
        {
            title: "Surat Pemberitahuan Memasuki Wilayah KKKS atau instansi Lain",
            relv: true,
            perc: obj["Surat Pemberitahuan Memasuki Wilayah KKKS atau instansi Lain (%)"] * 100    || 0
        },
        {
            title: "Izin Peledak",
            relv: true,
            perc: obj["Izin Peledak (%)"] * 100    || 0
        },
        // {
        //     title: "Persetujuan Penggunaan Kawasan Hutan (PPKH)",
        //     relv: true,
        //     perc: obj["Persetujuan Penggunaan Kawasan Hutan (PPKH) (%)"] * 100    || 0
        // },
        {
            title: "Security Clearance",
            relv: true,
            perc: obj["Security Clearance (%)"] * 100    || 0
        },
        {
            title: "Liason Office",
            relv: true,
            perc: obj["Liason Office (%)"] * 100    || 0
        },
        // {
        //     title: "PPKA (Persetujuan Penggunaan Kapal Asing)",
        //     relv: true,
        //     perc: obj["PPKA (Persetujuan Penggunaan Kapal Asing) (%)"] * 100    || 0
        // },
        {
            title: "Sertifikat Personel atau Sertifikat Keahlian sesuai SKNI Migas",
            relv: true,
            perc: obj["Sertifikat Personel atau Sertifikat Keahlian sesuai SKNI Migas (%)"] * 100    || 0
        },
        {
            title: "Project Plan / Project Summary, Mom Teknis Persetujuan Surveii, dan Scope Of Work",
            relv: true,
            perc: obj["Project Plan / Project Summary, Mom Teknis Persetujuan Surveii, dan Scope Of Work (%)"] * 100    || 0
        },
        {
            title: "Sosialisasi",
            relv: true,
            perc: obj["Sosialisasi (%)"] * 100    || 0
        }
    ]
}
...
insert_obj(client, 'MERN-geosurvey-01', 'Project', sheet_json, target_col).catch(console.dir)
